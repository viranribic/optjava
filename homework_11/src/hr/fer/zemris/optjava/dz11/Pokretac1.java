...
import hr.fer.zemris.optjava.dz11.geneticAlgorithm.population.MulThreadGA1;
...
public class Pokretac1 {
	...
	public static void main(String[] args) {
		...
		IOptAlgorithm<GASolution<int[]>> algorithm=new MulThreadGA1(popSize,minFit,maxIter,function,pngSrcPath,sqrNum);
