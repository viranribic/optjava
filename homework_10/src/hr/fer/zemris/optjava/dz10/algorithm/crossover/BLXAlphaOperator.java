...
public class BLXAlphaOperator {
	 ...
	 */
	public NSGA2Solution crossover(NSGA2Solution parentA, NSGA2Solution parentB, double alpha) {
		int solutionDim = parentA.getDecisionDimension();
		NSGA2Solution offspring = parentA.newLikeThis();
		double cMin;
		double cMax;
		double I;
		double upperB;
